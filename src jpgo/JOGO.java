...
public class JOGO extends javax.swing.JFrame {
    ...
    public JOGO() {
        cont  = 5;
        num = Double.valueOf(gerar.nextInt(100));
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(243, 206, 234));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       Double palpite = Double.parseDouble(jTextField1.getText());
       
       if(palpite < num){
           jLabel2.setText(" O numero é maior! ");
           cont--;
       }else if( palpite > num){
           jLabel2.setText("O numero é menor!");
           cont --;
       }else{
           jLabel1.setText("VOCÊ ACERTOU!!!");
       }
       if (cont == 0){
          jLabel2.setText("Você errou :(" + num);
       }
